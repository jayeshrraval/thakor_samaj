...
export default function ProfileScreen() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      {/* Header / Cover */}
      <div className="bg-gradient-to-br from-deep-blue to-[#800000] pb-24 pt-10 px-6 rounded-b-[2.5rem] shadow-lg">
      ...
      <div className="px-6 -mt-10 space-y-4">
        ...
        <p className="text-center text-gray-400 text-xs mt-4">Version 1.0.0 • ઠાકોર સમાજ સંગઠન</p>
      </div>
