...
export default function JobPostScreen() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 font-gujarati"> {/* pb-24 જેથી બોટમ નેવ કપાય નહીં */}
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-red-900 to-indigo-700 p-6 pt-12 rounded-b-[30px] shadow-lg sticky top-0 z-20">
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-sm text-red-900 font-medium flex items-center mt-1">
              ...
              <button
                ...
                className="w-full bg-red-900 text-white py-3 rounded-xl font-bold flex items-center justify-center space-x-2 active:scale-95 transition-all hover:bg-blue-700"
              >
